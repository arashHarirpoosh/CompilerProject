...
_lr_productions = [
  ...
  ('elseiflist -> elseiflist ELIF LRB exp RRB stmt','elseiflist',6,'p_elseiflist','Parser.py',201),
  ('elseiflist -> <empty>','elseiflist',0,'p_elseiflist','Parser.py',202),
  ('exp -> lvalue ASSIGN exp','exp',3,'p_exp','Parser.py',217),
  ('exp -> exp operator exp','exp',3,'p_exp','Parser.py',218),
  ('exp -> exp relop exp','exp',3,'p_exp','Parser.py',219),
  ('exp -> const','exp',1,'p_exp','Parser.py',220),
  ('exp -> lvalue','exp',1,'p_exp','Parser.py',221),
  ('exp -> ID LRB explist RRB','exp',4,'p_exp','Parser.py',222),
  ('exp -> LRB exp RRB','exp',3,'p_exp','Parser.py',223),
  ('exp -> ID LRB RRB','exp',3,'p_exp','Parser.py',224),
  ('exp -> SUB exp','exp',2,'p_exp','Parser.py',225),
  ('exp -> NOT exp','exp',2,'p_exp','Parser.py',226),
  ('operator -> OR','operator',1,'p_operator','Parser.py',255),
  ('operator -> AND','operator',1,'p_operator','Parser.py',256),
  ('operator -> SUM','operator',1,'p_operator','Parser.py',257),
  ('operator -> SUB','operator',1,'p_operator','Parser.py',258),
  ('operator -> MUL','operator',1,'p_operator','Parser.py',259),
  ('operator -> DIV','operator',1,'p_operator','Parser.py',260),
  ('operator -> MOD','operator',1,'p_operator','Parser.py',261),
  ('const -> INTEGERNUMBER','const',1,'p_const','Parser.py',275),
  ('const -> FLOATNUMBER','const',1,'p_const','Parser.py',276),
  ('const -> TRUE','const',1,'p_const','Parser.py',277),
  ('const -> FALSE','const',1,'p_const','Parser.py',278),
  ('relop -> GT','relop',1,'p_relop','Parser.py',289),
  ('relop -> LT','relop',1,'p_relop','Parser.py',290),
  ('relop -> NE','relop',1,'p_relop','Parser.py',291),
  ('relop -> EQ','relop',1,'p_relop','Parser.py',292),
  ('relop -> GE','relop',1,'p_relop','Parser.py',293),
  ('relop -> LE','relop',1,'p_relop','Parser.py',294),
  ('explist -> exp','explist',1,'p_explist','Parser.py',307),
  ('explist -> explist COMMA exp','explist',3,'p_explist','Parser.py',308),
]
